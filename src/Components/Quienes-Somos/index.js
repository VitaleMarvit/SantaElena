...
import letraG from '../Assets/Letra-G.svg';
...
function QuienesSomos() {
    return (
        <section id="somos" className="section-somos">
            ...
            <div className="container-texto-imagenes-section-somos-dos">
                <div className="container-p-section-somos">
                    <p className="p-texto-section-somos p-uno-section-somos"><img src={letraG} />rupo Santa Elena (GSE) en conjunto con Galbros desarrollos conforman un <span className="span-texto-somos"> equipo de profesionales altamente capacitados y con amplia trayectoria en el rubro,</span> enfocados en ofrecer proyectos innovadores y de alta calidad que se adaptan a las demandas del mercado.</p>

                    <p className="p-texto-section-somos">Desde Grupo Santa Elena y Galbros estamos comprometidos en brindarte una experiencia única en la compra de tu nueva propiedad.<span className="span-texto-somos">Desde el momento en que te acercas a nuestras oficinas, nuestro equipo de especialistas te acompañará en todo el proceso,</span> brindándote el conocimiento y la experiencia necesaria para tomar la mejor decisión.</p>
